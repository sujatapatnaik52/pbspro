...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_pbs_ifl')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_pbs_ifl')
...
ATTR_sched_port = _pbs_ifl.ATTR_sched_port
...
class batch_status(_object):
    ...
    if _newclass:
        next = _swig_property(_pbs_ifl.batch_status_next_get, _pbs_ifl.batch_status_next_set)
    __swig_setmethods__["name"] = _pbs_ifl.batch_status_name_set
    __swig_getmethods__["name"] = _pbs_ifl.batch_status_name_get
    if _newclass:
        name = _swig_property(_pbs_ifl.batch_status_name_get, _pbs_ifl.batch_status_name_set)
    ...
    if _newclass:
        attribs = _swig_property(_pbs_ifl.batch_status_attribs_get, _pbs_ifl.batch_status_attribs_set)
    __swig_setmethods__["text"] = _pbs_ifl.batch_status_text_set
    __swig_getmethods__["text"] = _pbs_ifl.batch_status_text_get
    if _newclass:
        text = _swig_property(_pbs_ifl.batch_status_text_get, _pbs_ifl.batch_status_text_set)
...
class ecl_attrerr(_object):
    ...
    if _newclass:
        ecl_attribute = _swig_property(_pbs_ifl.ecl_attrerr_ecl_attribute_get, _pbs_ifl.ecl_attrerr_ecl_attribute_set)
    ...
    if _newclass:
        ecl_errcode = _swig_property(_pbs_ifl.ecl_attrerr_ecl_errcode_get, _pbs_ifl.ecl_attrerr_ecl_errcode_set)
    ...
    if _newclass:
        ecl_errmsg = _swig_property(_pbs_ifl.ecl_attrerr_ecl_errmsg_get, _pbs_ifl.ecl_attrerr_ecl_errmsg_set)
...
class ecl_attribute_errors(_object):
    ...
    if _newclass:
        ecl_numerrors = _swig_property(_pbs_ifl.ecl_attribute_errors_ecl_numerrors_get, _pbs_ifl.ecl_attribute_errors_ecl_numerrors_set)
    ...
    if _newclass:
        ecl_attrerr = _swig_property(_pbs_ifl.ecl_attribute_errors_ecl_attrerr_get, _pbs_ifl.ecl_attribute_errors_ecl_attrerr_set)
...
pbs_relnodesjob = _pbs_ifl.pbs_relnodesjob
...
pbs_modify_resv = _pbs_ifl.pbs_modify_resv
